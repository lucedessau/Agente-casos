...
Base de conocimiento para que un agente (Claude) redacte los casos de los consultantes de **Seba Luce** con su misma
estructura y estilo, a partir de las transcripciones de las sesiones.

- [`CLAUDE.md`](CLAUDE.md): instrucciones del agente (rol, reglas, flujo de trabajo).
- [`docs/ciclo.md`](docs/ciclo.md): el ciclo de consultas y el orden de los pasos.
- [`docs/estilo.md`](docs/estilo.md): voz, formato, fórmulas fijas y glosario.
