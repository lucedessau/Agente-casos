# El ciclo de consultas BEC

Un ciclo completo son **20 a 25 consultas** online de ~2 h 30 min, separadas por una **cuarentena** de 30 a 40 días.
Cada consulta (desde la 2da) empieza con la **Actualización de cuarentena** y termina con **"Continuará…"**.

Todo el ciclo se escribe en un solo documento por consultante: **`APELLIDO_EXPERIENCIA DE CONSULTA`**.

## Orden de los pasos

| # | Paso | Etapa (del método) | Consultas típicas | Guía |
|---|---|---|---|---|
...
```
Actualización al D/M/AAAA               ← desde la 2da consulta
<Nombre> me cuenta de su cuarentena:
Con respecto a lo físico/personal: …
Con respecto a vínculos/pareja: …
Con respecto a lo económico/laboral: …

Nª consulta                              ← negrita + subrayado
<Frase de paso>                          ← itálica: "Continuamos ciclo horizontal", "Comenzamos 4PP", "Seguimos con RU"…

<Trabajo del paso>

Recurso / Estado de cielo                ← uno solo por consulta, al final

Continuará…
```

## Abreviaturas que usa Seba

| Sigla | Significado |
|---|---|
| BEC | Bioexistencia Consciente |
| BEX EyE | Bioexistencia aplicada a Empresas y Economía (formulario económico) |
| HP | Humano Puente |
| LT / Ldt | Línea de tiempo |
| 4PP | 4 primeros pasos |
| RU | Reprogramación de útero |
...
| PAC | Planilla de control del Campus (intermedia / cierre) |
